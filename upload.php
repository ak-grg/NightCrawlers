...
if(isset($_FILES['image']['name'])){	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/nc/assets/images/profile_pics';
	//Set File name	
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		$insert_pic_query = mysqli_query($con, "UPDATE USERS SET PROFILE_PIC='$result_path' WHERE USER_NAME='$userLoggedIn'");
